 ...
 * =======================================
 * S2剧情：		    星际转运（part1）
 * 文件名：		    E1-interstellar-p1
 * 创建日期：	    2023-02-06
 * 时间线索引：		S2【E1-0】&【E1-1】&【E1-1A】&【E1-1B】
 * 写手：			ito
 * 程序演绎：		栗子
 *
 *  如何整合进主线剧情：
 * （1）在主线剧情中使用命令：jump E10-DE
 * （2）在本文件的E11-foudation中设定支线结束后的回传位置
 *
 *  更新：
 * 	230121 【ito】本剧情对应S2子文件夹【E1】星际转运。
 *          星际线分P编写，该文件为P1。
 *          本章节的场景图片和立绘尚未完全完成，可以先用子文件夹下的绘画参考图作暂预览使用；建议设置便于检索的标记，方便之后统一替换。
 *          具体剧情跳转关系参照工作文件夹下【E1方舱-星际转运剧情线v3】。（前两个版本已弃用，请注意参考正确的时间线）
 * 			如果程序员已对以上部分进行了优化，请在此条下留言已优化的部分，并且指出待优化的问题，以便后续进一步工作。
 *  230227 【栗子】已优化：补充了音效资源，已抠图立绘，
 *          待优化：【美术】部分CG、立绘、背景待美术资源补入后添加（检索关键词：补入）。
 *          打断对话效果。解锁世界线。
 *          部分音效演出待补充：飞船撞击，气流声。
 *          
 * =======================================
