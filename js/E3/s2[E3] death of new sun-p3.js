 ...
 monogatari.script ({
    ...
    **/
    ...
    'E3-S5-3-1':[
        ...
        'show character a happy',
        'a 那正好，一会儿一块去申请吧。',
        'show scene factor_bright with fadeIn duration 3s',
        ...
        'i 好主意。',
        'centered',
        'show scene village_bright with fadeIn duration 3s',
        'centered',
        ...
        'i （这不是说了一大堆吗）',
        'show scene ice_night_bright with fadeIn duration 3s',
