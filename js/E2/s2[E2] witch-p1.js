...
monogatari.script({
  ...
  'E2-S0':[ 
    {'Function':{
      ...
      'i （好家伙，这就是您勒我舌头的原因？）',
      'hide character hyzj',
      'stop music E2_danger with fade 7',
...
**/
  'E2-S1-1':[
    ...
    'elena 你这癞蛤蟆就该关死在地窖里！',
    'pink 瞧你说的，咱们也要体谅体谅教皇嘛……现在邻国国王跟我们教廷较劲，竟然开始给主教大人们征关税了，真是想钱想疯了。',
    ...
    'hide character cma',
    'show character elena titter',
    'elena 借你没问题，不过你说它丑，它记仇，盖到你身上也要烧着！',
    'i ……',
    ...
    'i 嗯……',
    'hide character elena',
    //'show scene moon with fadeIn duration 3s',需要一个夜晚crypt
    'play sound cicada',
...
'E2-S7-2':[
  ...
  **/
  ...
  'hyzj 此刻，让神的双眼成为诸位的双眼，神的喉舌成为诸位的喉舌。阿门。',
  'zcm 阿门。',
  'hide character hyzj',
  'i ……',
  ...
  's 所以话语的尊严都是在沉默中显现吗？还是沉默是人最后的自尊？你打了个寒颤，主教方才的言语忽然浮上脑海。',
...
'E2-S9-1':[
  ...
  'lpsg 上头今年的指标是好歹有十个候选人，后面再择优录取。好家伙，这眼睛一闭一睁，都快到年底了，还好各位来得及时，我可想死你们啦！',
  'lpsg 我们这边的常规工作是和方检测。',
  'lpsg 什么是和方检测呢？就是用这把方形的小铁钳在各位脑门儿上这么一戳！嘿，大家伙儿额头上就能立马现出一个鲜红鲜红的印子～',
  'lpsg 这原理也不稀奇，各位能懂几成是几成～上头文件发下来，说只有真正的圣女能保持红印子不发黑。',
  'show character lpsg mock',
  'lpsg 这玄乎事体咱也弄不明白，总之上头怎么说咱就怎么办，各位好生配合就是了！~',
  'hide character lpsg',
  'i （大哥，那叫结痂，血小板参与的上皮再生。）',
  's 你们听完这段奇特甚至有些疯癫的发言，默默地排成一列，开始等待接受和方检测。',
  'show character lpsg normal',
  's 蓝袍神官的衣袍整洁，一丝不苟，手中的烙铁也光滑平整，干净利落。',
  's 先用黑色液体涂抹受试者额头，使其清凉舒爽；随后手持烫红的烙铁，认真检查温度；最后对准眉心按压，大功告成。',
  'hide character lpsg',
  'centered',
  'show character elena red',
  'centered',
  'elena ……',
  ...
  's 你们众人不到半日便完成了检测指标。',
  'show character lpsg mock',
  'lpsg 这下得跟大家告别啦，各位圣女候选人将进入神殿的核心，也就是白厅~',
  ...
  'play sound footsteps',
  's 幸运的是，有个候选人起身向修女示意。一行人走向大殿的侧门，你连忙跟了上去。',
  ...
  'i （……有没有可能，那不是幻觉？）',
  's 你边啃面包，边在长桌的一侧偷偷观察先前那个“去厕所”的女孩。',
  'centered',
  'show character cmb branded',
  'centered',
  'i （她的印记……变得更红了……）',
...
'E2-S10-1':[  
  ...
  's 临睡前，你拉住了一位修女的衣角，向旋转楼梯的方向指去。她心领神会。',
  'centered',
  'play sound footsteps',
  'show scene stairs with fadeIn duration 3s',
  'show character bpxn normal',
  ...
  's 只是多了午夜时分的“二次检测”。',
  'i （也许她们看来，真正的信总要如血一般不断流淌着才能鲜活吧，呵呵……）',
  's 在持续疼痛的晕眩中，你如此想着，然后缓缓陷入睡眠。',
  'jump E2-S12-1',
  //跳转到【12-1】
],
...
'E2-S13-1':[
  ...
  's ……',
  's 有些出乎你意料的是，修女们战力为零，计划十分顺利地进行，你毫不费力地打开了蓝厅的门。',
  'show scene bluehall with fadeIn duration 3s',
  'i ……',
  's 空无一人，深海一样的寂静。',
  's 蓝厅的三面墙上各有一扇门。',
...
'E2-S13-3':[
  ...
  'show scene #000000',
  'centered',
  'show scene village fire with fadeIn duration 7s',
  'centered',
