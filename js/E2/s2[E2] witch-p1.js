...
monogatari.script({
  ...
  'E2-S0':[ 
    {'Function':{
      ...
      'wait 1000',
      'play sound click_button',
      'show scene E2_scanning3',
      'wait 500',
      'play sound click_button',
      'show scene E2_scanning4',
      'wait 500',
      'play sound click_button',
      'show scene E2_scanning5',
      'wait 500',
      'play sound click_button',
      'show scene E2_scanning6',
      'wait 500',
      'play sound click_button',
      'show scene E2_scanning7',
      'wait 500',
      'play sound click_button',
...
'E2-S7-2':[
  ...
  **/
  ...
  'hyzj 此刻，让神的双眼成为诸位的双眼，神的喉舌成为诸位的喉舌。阿克。',
  'zcm 阿克。',
  'hide character hyzj',
  'i ……',
...
'E2-S9-1':[
  ...
  'show character lpsg mock',
  'lpsg 哎呀呀，可爱的小姐，您怎么皱眉头呀，是不是我这厢下手重啦？',
  'lpsg 您尽管提嘛～我们这都是为大家服务，大家满意才是皆大欢喜！',
  'i 唔……唔唔……',
  'i （呵呵，说的好像我能说出半个不字一样。）',
  'hide character lpsg',
  's 你们众人不到半日便完成了检测指标。',
