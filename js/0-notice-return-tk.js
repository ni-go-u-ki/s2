 ...
 *  230225 【栗子】已优化：按照ito的注释演绎，增加了闪回画面、弹窗、音效、隐藏已读选项等效果。
 *          待优化：【wx聊天窗口】目前还无法很好地实现出群聊效果（显示发消息者名字）。
 *         【剧情跳转】测试员跳转、校外租住线跳转、校内核酸线跳转、True Ending解锁后彩蛋的逻辑待文案完成后补充。
 *         【闪回画面使用image或scene命令】不确定在不同设备上的显示效果，需要后期测试后再调试。
 *              
 * =======================================
 **/
